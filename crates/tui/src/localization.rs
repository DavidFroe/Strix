...
impl Locale {
    ...
    pub fn shipped() -> &'static [Self] {
        &[Self::En, Self::De, Self::Ja, Self::ZhHans, Self::PtBr]
    }
}
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::CmdSubmodelDescription,
...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::CmdSubmodelDescription => "Switch or view sub-agent / background model",
        ...
        MessageId::KbCycleModel => "Cycle main model (Ctrl+Tab in kitty; Ctrl+N universal)",
        ...
        MessageId::HomeDashboardTitle => "Propeller Home Dashboard",
...
fn german(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::HistoryHintAccept => "Enter übernehmen",
        MessageId::HistoryHintRestore => "Esc zurücksetzen",
        MessageId::HistoryNoMatches => "  Keine Treffer",
        MessageId::ConfigTitle => "Sitzungskonfiguration",
        MessageId::ConfigModalTitle => " Einstellungen ",
        MessageId::ConfigSearchPlaceholder => "eingeben zum Filtern",
        MessageId::ConfigNoSettings => "  Keine Einstellungen verfügbar.",
        MessageId::ConfigNoMatchesPrefix => "  Keine Einstellungen für ",
        MessageId::ConfigFilteredSettings => "  Gefilterte Einstellungen",
        MessageId::ConfigShowing => "  Anzeige",
        MessageId::ConfigFooterDefault => {
            " eingeben=filtern, Auf/Ab=auswählen, Enter/e=bearbeiten, Esc/q=schließen "
        }
        MessageId::ConfigFooterScrollable => {
            " eingeben=filtern, Auf/Ab=auswählen, Enter/e=bearbeiten, BdAuf/BdAb=scrollen, Esc/q=schließen "
        }
        MessageId::ConfigFooterFiltered => {
            " eingeben=filtern, Rücktaste=löschen, Ctrl+U/Esc=leeren, Enter=bearbeiten "
        }
        MessageId::HelpTitle => "Hilfe",
        MessageId::HelpFilterPlaceholder => "Zum Filtern eingeben",
        MessageId::HelpFilterPrefix => "Filter: ",
        MessageId::HelpNoMatches => "  Keine Treffer.",
        MessageId::HelpSlashCommands => "Slash-Befehle",
        MessageId::HelpKeybindings => "Tastenkürzel",
        MessageId::HelpFooterTypeFilter => " eingeben zum Filtern ",
        MessageId::HelpFooterMove => "  Auf/Ab bewegen ",
        MessageId::HelpFooterJump => " BdAuf/BdAb springen ",
        MessageId::HelpFooterClose => " Esc schließen ",
        MessageId::CmdAnchorDescription => {
            "Wichtige Fakten anheften, die Komprimierung überleben (automatisch in Kontext eingefügt)"
        }
        MessageId::CmdAttachDescription => {
            "Bild/Video anhängen; @pfad für Textdateien oder Verzeichnisse"
        }
        MessageId::CmdCacheDescription => {
            "DeepSeek Prefix-Cache Treffer/Fehler-Statistik der letzten N Runden anzeigen"
        }
        ...
        MessageId::CmdCostDescription => "Kostenzusammenfassung der Sitzung anzeigen",
        MessageId::CmdCycleDescription => "Übergabe-Briefing eines bestimmten Zyklus anzeigen",
        MessageId::CmdCyclesDescription => {
            "Checkpoint-Neustart-Zyklen dieser Sitzung auflisten"
        }
        MessageId::CmdDiffDescription => "Dateiänderungen seit Sitzungsstart anzeigen",
        MessageId::CmdEditDescription => "Letzte Nachricht überarbeiten und erneut senden",
        MessageId::CmdExitDescription => "Anwendung beenden",
        MessageId::CmdExportDescription => "Gespräch als Markdown exportieren",
        MessageId::CmdFeedbackDescription => "GitHub-Feedback-URL generieren",
        MessageId::CmdHelpDescription => "Hilfe anzeigen",
        MessageId::CmdHomeDescription => "Start-Dashboard mit Statistiken und Schnellaktionen anzeigen",
        MessageId::CmdHooksDescription => "Konfigurierte Lifecycle-Hooks auflisten (schreibgeschützt)",
        MessageId::CmdGoalDescription => "Sitzungsziel mit optionalem Token-Budget festlegen",
        MessageId::CmdInitDescription => "AGENTS.md für das Projekt generieren",
        MessageId::CmdLspDescription => "LSP-Diagnose ein- oder ausschalten",
        MessageId::CmdShareDescription => "Aktuelle Sitzung als teilbare Web-URL exportieren",
        MessageId::CmdJobsDescription => "Hintergrund-Shell-Jobs prüfen und steuern",
        MessageId::CmdLinksDescription => "DeepSeek Dashboard- und Dokumentations-Links anzeigen",
        MessageId::CmdLoadDescription => "Sitzung aus Datei laden",
        MessageId::CmdLogoutDescription => "API-Schlüssel löschen und zur Einrichtung zurückkehren",
        MessageId::CmdMcpDescription => "MCP-Server öffnen oder verwalten",
        MessageId::CmdMemoryDescription => "Persistente Benutzerspeicherdatei prüfen oder verwalten",
        MessageId::CmdModeDescription => {
            "Modus wechseln oder Auswahl öffnen: /mode [agent|plan|yolo|1|2|3]"
        }
        MessageId::CmdModelDescription => "Aktuelles Modell wechseln oder anzeigen",
        MessageId::CmdModelsDescription => "Verfügbare Modelle von der API auflisten",
        MessageId::CmdSubmodelDescription => "Subagenten-/Hintergrundmodell wechseln oder anzeigen",
        MessageId::CmdNetworkDescription => "Netzwerk-Erlaubnis- und Sperr-Regeln verwalten",
        MessageId::CmdNoteDescription => {
            "Notiz zur persistenten Notizendatei (.deepseek/notes.md) hinzufügen"
        }
        MessageId::CmdThemeDescription => "Zwischen hellem und dunklem Design wechseln",
        MessageId::CmdProviderDescription => {
            "Aktives LLM-Backend wechseln oder anzeigen (deepseek | nvidia-nim | ollama)"
        }
        MessageId::CmdQueueDescription => "Eingereihte Nachrichten anzeigen oder bearbeiten",
        MessageId::CmdRecallDescription => {
            "Frühere Zyklus-Archive durchsuchen (BM25 über Nachrichtentext)"
        }
        MessageId::CmdRenameDescription => "Aktuelle Sitzung umbenennen",
        MessageId::CmdRestoreDescription => {
            "Arbeitsbereich auf einen früheren Vorher/Nachher-Schnappschuss zurücksetzen. Ohne Argument werden jüngste Schnappschüsse aufgelistet."
        }
        MessageId::CmdRetryDescription => "Letzte Anfrage wiederholen",
        MessageId::CmdReviewDescription => {
            "Strukturiertes Code-Review für Datei, Diff oder PR durchführen"
        }
        MessageId::CmdRlmDescription => {
            "Rekursiver Sprachmodell-Turn (RLM) — Prompt in Python-REPL speichern und Modell Code schreiben lassen; `llm_query()` / `sub_rlm()` für Sub-LLM-Aufrufe."
        }
        MessageId::CmdSaveDescription => "Sitzung in Datei speichern",
        MessageId::CmdSessionsDescription => "Sitzungsauswahl öffnen",
        MessageId::CmdSettingsDescription => "Persistente Einstellungen anzeigen",
        MessageId::CmdSkillDescription => {
            "Skill aktivieren oder Community-Skill installieren/aktualisieren/deinstallieren/vertrauen"
        }
        MessageId::CmdSkillsDescription => {
            "Lokale Skills auflisten (Filter: `/skills <präfix>`; --remote durchsucht das kuratierte Verzeichnis)"
        }
        MessageId::CmdStashDescription => {
            "Entwurf parken oder wiederherstellen (Ctrl+S zum Parken, /stash list/pop)"
        }
        MessageId::CmdStatusDescription => "Laufenden Sitzungsstatus anzeigen",
        MessageId::CmdStatuslineDescription => "Angezeigte Elemente in der Fußzeile konfigurieren",
        MessageId::CmdSubagentsDescription => "Subagenten-Status auflisten",
        MessageId::CmdSwarmDescription => {
            "Multi-Agenten-Fanout-Turn ausführen (sequential | mixture | distill | deliberate)"
        }
        MessageId::CmdSystemDescription => "Aktuellen System-Prompt anzeigen",
        MessageId::CmdTaskDescription => "Hintergrundaufgaben verwalten",
        MessageId::CmdTokensDescription => "Token-Nutzung der Sitzung anzeigen",
        MessageId::CmdTrustDescription => {
            "Arbeitsbereich-Vertrauen und Pfad-Erlaubnisliste verwalten (`/trust add <pfad>`, `/trust list`, `/trust on|off`)"
        }
        MessageId::CmdUndoDescription => "Letztes Nachrichten-Paar entfernen",
        MessageId::CmdVerboseDescription => "Vollständige Live-Gedanken im Protokoll ein-/ausschalten",
        MessageId::CmdCacheAdvice => {
            "Trefferquoten über ~70 % nach dem dritten Turn zeigen einen stabilen Cache-Präfix;\n\
             bei langen Sitzungen darunter lohnt sich eine Untersuchung des Präfix-Drifts (#263)."
        }
        MessageId::CmdCacheFootnote => {
            "* Fehler aus Eingabe − Treffer geschätzt, wenn der Anbieter ihn nicht separat meldet.\n"
        }
        MessageId::CmdCacheHeader => {
            "Cache-Telemetrie — letzte {count} von {total} Turn(s) (Modell: {model})\n"
        }
        MessageId::CmdCacheNoData => {
            "Cache-Verlauf: Noch keine Turns aufgezeichnet.\n\n\
             DeepSeek meldet `prompt_cache_hit_tokens` / `prompt_cache_miss_tokens` \
             bei jedem API-Turn für unterstützte Modelle (V4-Familie). Führen Sie einen Turn aus \
             und versuchen Sie /cache erneut."
        }
        MessageId::CmdCacheTotals => {
            "Σ Eingabe: {sum_in}   Σ Treffer: {sum_hit}   Σ Fehler: {sum_miss}   ⌀ Trefferquote: {avg}\n"
        }
        MessageId::CmdCostReport => {
            "Sitzungskosten:\n\
             ─────────────────────────────\n\
             Ungefähre Gesamtkosten: {cost}\n\n\
             Kostenschätzungen sind Näherungswerte basierend auf Anbieter-Telemetrie.\n\n\
             DeepSeek API-Preise:\n\
             ─────────────────────────────\n\
             Detaillierte Preise sind in diesem CLI nicht konfiguriert."
        }
        MessageId::CmdTokensCacheBoth => "{hit} Treffer / {miss} Fehler",
        MessageId::CmdTokensCacheHitOnly => "{hit} Treffer / Fehler nicht gemeldet",
        MessageId::CmdTokensCacheMissOnly => "Treffer nicht gemeldet / {miss} Fehler",
        MessageId::CmdTokensContextUnknownWindow => "~{estimated} / Kontextfenster unbekannt",
        MessageId::CmdTokensContextWithWindow => "~{used} / {window} ({percent}%)",
        MessageId::FooterAgentSingular => "1 Agent",
        MessageId::FooterAgentsPlural => "{count} Agenten",
        MessageId::FooterPressCtrlCAgain => "Ctrl+C erneut drücken zum Beenden",
        MessageId::FooterWorking => "Arbeitet",
        MessageId::HelpSectionActions => "Aktionen",
        MessageId::HelpSectionClipboard => "Zwischenablage",
        MessageId::HelpSectionEditing => "Eingabe bearbeiten",
        MessageId::HelpSectionHelp => "Hilfe",
        MessageId::HelpSectionModes => "Modi",
        MessageId::HelpSectionNavigation => "Navigation",
        MessageId::HelpSectionSessions => "Sitzungen",
        MessageId::CmdTokensNotReported => "nicht gemeldet",
        MessageId::CmdTokensReport => {
            "Token-Nutzung:\n\
             ─────────────────────────────\n\
             Aktiver Kontext:       {active}\n\
             Letzter API-Eingang:   {input} (Turn-Telemetrie)\n\
             Letzter API-Ausgang:   {output}\n\
             Cache Treffer/Fehler:  {cache} (nur Telemetrie/Kosten)\n\
             Kumulierte Tokens:     {total} (Sitzungs-Nutzungstelemetrie)\n\
             Ungefähre Sitzungskosten: {cost}\n\
             API-Nachrichten:       {api_messages}\n\
             Chat-Nachrichten:      {chat_messages}\n\
             Modell:                {model}"
        }
        MessageId::KbScrollTranscript => {
            "Protokoll scrollen, Eingabeverlauf navigieren oder Anhänge auswählen"
        }
        MessageId::KbNavigateHistory => "Eingabeverlauf navigieren",
        MessageId::KbScrollTranscriptAlt => "Protokoll scrollen",
        MessageId::KbScrollPage => "Protokoll seitenweise scrollen",
        MessageId::KbJumpTopBottom => "Zum Anfang / Ende des Protokolls springen",
        MessageId::KbJumpTopBottomEmpty => "Zum Anfang / Ende springen (wenn Eingabe leer)",
        MessageId::KbJumpToolBlocks => "Zwischen Tool-Ausgabe-Blöcken springen",
        MessageId::KbMoveCursor => "Cursor im Eingabebereich bewegen",
        MessageId::KbJumpLineStartEnd => "Zum Zeilenanfang / -ende springen",
        MessageId::KbDeleteChar => {
            "Zeichen vor / nach dem Cursor löschen, oder ausgewählten Anhang entfernen"
        }
        MessageId::KbClearDraft => "Aktuellen Entwurf löschen",
        MessageId::KbStashDraft => "Aktuellen Entwurf parken (`/stash pop` zum Wiederherstellen)",
        MessageId::KbSearchHistory => "Prompt-Verlauf durchsuchen und lokale Entwürfe wiederherstellen",
        MessageId::KbInsertNewline => "Neue Zeile im Eingabebereich einfügen",
        MessageId::KbSendDraft => "Aktuellen Entwurf senden",
        MessageId::KbCloseMenu => "Menü schließen, Anfrage abbrechen, Entwurf verwerfen oder Eingabe leeren",
        MessageId::KbCancelOrExit => "Anfrage abbrechen oder bei Leerlauf beenden",
        MessageId::KbShellControls => "Shell-Steuerung für laufenden Vordergrundbefehl öffnen",
        MessageId::KbExitEmpty => "Beenden wenn Eingabe leer",
        MessageId::KbCommandPalette => "Befehlspalette öffnen",
        MessageId::KbFuzzyFilePicker => "Fuzzy-Dateiauswahl öffnen (@pfad bei Enter einfügen)",
        MessageId::KbCompactInspector => "Kompakten Sitzungskontext-Inspektor öffnen",
        MessageId::KbLastMessagePager => {
            "Pager für letzte Nachricht öffnen (wenn Eingabe leer)"
        }
        MessageId::KbSelectedDetails => {
            "Details für ausgewähltes Tool oder Nachricht öffnen (wenn Eingabe leer)"
        }
        MessageId::KbToolDetailsPager => "Tool-Details-Pager öffnen",
        MessageId::KbThinkingPager => "Denk-Pager öffnen",
        MessageId::KbLiveTranscript => "Live-Protokoll-Overlay öffnen (Sticky-Tail Auto-Scroll)",
        MessageId::KbBacktrackMessage => {
            "Zu einer früheren Benutzernachricht zurückgehen (Links/Rechts, Enter zum Zurückspulen)"
        }
        MessageId::KbCompleteCycleModes => {
            "/Befehl vervollständigen, Follow-up einreihen, Modi wechseln; Shift+Tab wechselt Denk-Intensität"
        }
        MessageId::KbJumpPlanAgentYolo => "Direkt zu Plan-/Agenten-/YOLO-Modus springen",
        MessageId::KbAltJumpPlanAgentYolo => "Alternativer Sprung zu Plan-/Agenten-/YOLO-Modus",
        MessageId::KbFocusSidebar => "Plan-/Todos-/Aufgaben-/Agenten-/Auto-Seitenleiste fokussieren",
        MessageId::KbTogglePlanAgent => "Zwischen Plan- und Agenten-Modus wechseln",
        MessageId::KbCycleModel => "Hauptmodell wechseln (Ctrl+Tab in kitty; Ctrl+N universell)",
        MessageId::KbSessionPicker => "Sitzungsauswahl öffnen",
        MessageId::KbPasteAttach => "Text einfügen oder Bild aus Zwischenablage anhängen",
        MessageId::KbCopySelection => "Aktuelle Auswahl kopieren (Cmd+C auf macOS)",
        MessageId::KbContextMenu => {
            "Kontextmenü für Einfügen, Auswahl, Nachrichtendetails, Kontext und Hilfe öffnen"
        }
        MessageId::KbAttachPath => "Lokale Textdatei oder Verzeichnis zum Kontext hinzufügen",
        MessageId::KbHelpOverlay => "Dieses Hilfe-Overlay öffnen (wenn Eingabe leer)",
        MessageId::KbToggleHelp => "Hilfe-Overlay ein-/ausblenden",
        MessageId::KbToggleHelpSlash => "Hilfe-Overlay ein-/ausblenden",
        MessageId::HelpUsageLabel => "Verwendung:",
        MessageId::HelpAliasesLabel => "Aliase:",
        MessageId::SettingsTitle => "Einstellungen:",
        MessageId::SettingsConfigFile => "Konfigurationsdatei:",
        MessageId::ClearConversation => "Gespräch gelöscht",
        MessageId::ClearConversationBusy => {
            "Gespräch gelöscht (Plan-Status beschäftigt; /clear erneut ausführen falls nötig)"
        }
        MessageId::ModelChanged => "Modell gewechselt: {old} \u{2192} {new}",
        MessageId::LinksTitle => "DeepSeek-Links:",
        MessageId::LinksDashboard => "Dashboard:",
        MessageId::LinksDocs => "Dokumentation:",
        ...
        MessageId::HomeHistory => "Verlauf:",
        MessageId::HomeTokens => "Tokens:",
        MessageId::HomeQueued => "In Warteschlange:",
        MessageId::HomeSubagents => "Subagenten:",
        MessageId::HomeSkill => "Skill:",
        MessageId::HomeQuickActions => "Schnellaktionen",
        MessageId::HomeQuickLinks => "/links      - Dashboard & API-Links",
        MessageId::HomeQuickSkills => "/skills      - Verfügbare Skills auflisten",
        MessageId::HomeQuickConfig => "/config      - Interaktiven Konfigurations-Editor öffnen",
        MessageId::HomeQuickSettings => "/settings    - Persistente Einstellungen anzeigen",
        MessageId::HomeQuickModel => "/model       - Modell wechseln oder anzeigen",
        MessageId::HomeQuickSubagents => "/subagents   - Subagenten-Status auflisten",
        MessageId::HomeQuickTaskList => "/task list   - Hintergrundaufgaben-Warteschlange anzeigen",
        MessageId::HomeQuickHelp => "/help        - Hilfe anzeigen",
        MessageId::HomeModeTips => "Modus-Tipps",
        MessageId::HomeAgentModeTip => "Agenten-Modus - Tools für autonome Aufgaben nutzen",
        MessageId::HomeAgentModeReviewTip => {
            "  Ctrl+X nutzen, um im Plan-Modus zu überprüfen vor der Ausführung"
        }
        MessageId::HomeAgentModeYoloTip => {
            "  /mode yolo eingeben für vollen Tool-Zugriff"
        }
        MessageId::HomeYoloModeTip => "YOLO-Modus - Voller Tool-Zugriff, keine Bestätigungen",
        MessageId::HomeYoloModeCaution => "  Vorsicht bei destruktiven Operationen!",
        MessageId::HomePlanModeTip => "Plan-Modus - Erst planen, dann umsetzen",
        MessageId::HomePlanModeChecklistTip => {
            "  /mode plan eingeben für strukturierte Checklisten"
        }
        // Onboarding — Sprachauswahl.
        MessageId::OnboardLanguageTitle => "Sprache wählen",
        MessageId::OnboardLanguageBlurb => {
            "UI-Sprache auswählen. Jederzeit änderbar mit `/settings set locale <tag>`."
        }
        MessageId::OnboardLanguageFooter => {
            "1-5 drücken zum Auswählen, oder Enter zum Beibehalten der aktuellen Einstellung"
        }
        // Onboarding — API-Schlüssel.
        MessageId::OnboardApiKeyTitle => "DeepSeek API-Schlüssel verbinden",
        MessageId::OnboardApiKeyStep1 => {
            "Schritt 1.  https://platform.deepseek.com/api_keys öffnen und Schlüssel erstellen."
        }
        MessageId::OnboardApiKeyStep2 => "Schritt 2.  Unten einfügen und Enter drücken.",
        MessageId::OnboardApiKeySavedHint => {
            "In ~/.deepseek/config.toml gespeichert, sodass es aus jedem Ordner funktioniert."
        }
        MessageId::OnboardApiKeyFormatHint => {
            "Den vollständigen Schlüssel genau wie ausgegeben einfügen (keine Leerzeichen oder Zeilenumbrüche)."
        }
        MessageId::OnboardApiKeyPlaceholder => "(Schlüssel hier einfügen)",
        MessageId::OnboardApiKeyLabel => "Schlüssel: ",
        MessageId::OnboardApiKeyFooter => "Enter zum Speichern, Esc zum Zurückgehen.",
        // Onboarding — Arbeitsbereich vertrauen.
        MessageId::OnboardTrustTitle => "Arbeitsbereich vertrauen",
        MessageId::OnboardTrustQuestion => "Vertrauen Sie dem Inhalt dieses Verzeichnisses?",
        MessageId::OnboardTrustLocationPrefix => "Sie befinden sich in ",
        MessageId::OnboardTrustRiskHint => {
            "Die Arbeit mit nicht vertrauenswürdigen Inhalten erhöht das Risiko von Prompt-Injection."
        }
        MessageId::OnboardTrustEffectHint => {
            "Diesem Verzeichnis zu vertrauen speichert es in der globalen Konfiguration und aktiviert den vertrauenswürdigen Arbeitsbereich-Modus."
        }
        MessageId::OnboardTrustFooterPrefix => "Drücken Sie ",
        MessageId::OnboardTrustFooterMiddle => " zum Vertrauen und Fortfahren, ",
        MessageId::OnboardTrustFooterSuffix => " zum Beenden",
        // Onboarding — Abschlusstipps.
        MessageId::OnboardTipsTitle => "Einfach starten",
        MessageId::OnboardTipsLine1 => {
            "Aufgabe in natürlicher Sprache eingeben. /help oder Ctrl+K für Befehle nutzen."
        }
        MessageId::OnboardTipsLine2 => {
            "Der untere Eingabebereich ist mehrzeilig: Enter sendet, Alt+Enter oder Ctrl+J fügt eine neue Zeile ein."
        }
        MessageId::OnboardTipsLine3 => {
            "Modi nur wechseln wenn sich die Aufgabe ändert: Plan für Review-first, Agent für Ausführung, YOLO für automatische Genehmigung."
        }
        MessageId::OnboardTipsLine4 => {
            "Ctrl+R setzt frühere Sitzungen fort, Esc bricht den aktuellen Entwurf oder das Overlay ab."
        }
        MessageId::OnboardTipsFooterEnter => "Enter drücken",
        MessageId::OnboardTipsFooterAction => " um den Arbeitsbereich zu öffnen",
    })
}
...
fn japanese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdSubmodelDescription => "サブエージェント／バックグラウンド用モデルを切り替え",
        ...
        MessageId::KbCycleModel => "メインモデルを切り替え (Ctrl+Tab / Ctrl+N)",
        ...
        MessageId::HomeDashboardTitle => "Propeller ホームダッシュボード",
...
fn chinese_simplified(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdSubmodelDescription => "切换或查看子代理 / 后台模型",
        ...
        MessageId::KbCycleModel => "切换主模型 (Ctrl+Tab / Ctrl+N)",
        ...
        MessageId::HomeDashboardTitle => "Propeller 主面板",
...
fn portuguese_brazil(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdSubmodelDescription => "Trocar ou exibir o modelo de subagente / background",
        ...
        MessageId::KbCycleModel => "Ciclar modelo principal (Ctrl+Tab / Ctrl+N)",
        ...
        MessageId::HomeDashboardTitle => "Painel Inicial do Propeller",
...
mod tests {
    ...
    fn locale_setting_normalizes_supported_tags() {
        ...
        assert_eq!(normalize_configured_locale("de-AT"), Some("de"));
        assert_eq!(normalize_configured_locale("de-CH"), Some("de"));
