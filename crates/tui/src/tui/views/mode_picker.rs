//! `/mode` picker for Agent / Plan / YOLO / Propeller.
...
const MODE_ROWS: &[ModeRow] = &[
    ...
    ModeRow {
        mode: AppMode::Propeller,
        number: '4',
        name: "Propeller",
        hint: "Auto-approve with Propeller identity",
    },
];
...
impl ModalView for ModePickerView {
    ...
    fn render(&self, area: Rect, buf: &mut Buffer) {
        ...
        let popup_height = 10.min(area.height.saturating_sub(4)).max(8);
        let popup_area = Rect {
        ...
        lines.push(Line::from(Span::styled(
            "Choose how Propeller should operate:",
