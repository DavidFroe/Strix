...
pub fn canonical_model_name(model: &str) -> Option<&'static str> {
    match model.trim().to_ascii_lowercase().as_str() {
        "deepseek-v4pro" | "owltrail-pro" | "owltrail" => Some("deepseek-v4-pro"),
        "deepseek-v4flash" | "owltrail-flash" => Some("deepseek-v4-flash"),
        "owltrail-web" => Some("deepseek-v4-web"),
        _ => None,
    }
}
...
fn provider_preserves_custom_base_url_model(provider: ApiProvider, base_url: &str) -> bool {
    matches!(provider, ApiProvider::Openrouter | ApiProvider::Deepseek | ApiProvider::DeepseekCN)
