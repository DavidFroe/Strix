...
static ACCENT: OnceLock<AccentColors> = OnceLock::new();

/// Call once at startup from propeller.conf. Silently ignored on second call.
pub fn init_theme(name: &str) {
    let colors = match name.trim().to_ascii_lowercase().as_str() {
        "red" => AccentColors {
            primary:   Color::Rgb(220,  60,  80),
            light:     Color::Rgb(255, 130, 140),
            border:    Color::Rgb(110,  25,  35),
            selection: Color::Rgb( 75,  18,  25),
        },
        "green" => AccentColors {
            primary:   Color::Rgb( 40, 190,  90),
            light:     Color::Rgb(100, 235, 150),
            border:    Color::Rgb( 18,  90,  40),
            selection: Color::Rgb( 12,  58,  28),
        },
        "yellow" => AccentColors {
            primary:   Color::Rgb(210, 170,  20),
            light:     Color::Rgb(255, 215,  80),
            border:    Color::Rgb(110,  90,   8),
            selection: Color::Rgb( 70,  58,   5),
        },
        "purple" => AccentColors {
            primary:   Color::Rgb(150,  80, 230),
            light:     Color::Rgb(195, 145, 255),
            border:    Color::Rgb( 80,  35, 130),
            selection: Color::Rgb( 52,  22,  85),
        },
        _ => AccentColors {  // "blue" or anything unknown
            primary:   Color::Rgb( 53, 120, 229),
            light:     Color::Rgb(106, 174, 242),
            border:    Color::Rgb( 42,  74, 127),
            selection: Color::Rgb( 26,  44,  74),
        },
    };
    let _ = ACCENT.set(colors);
}

fn accent_colors() -> &'static AccentColors {
    ACCENT.get_or_init(|| AccentColors {
        primary:   Color::Rgb( 53, 120, 229),
        light:     Color::Rgb(106, 174, 242),
        border:    Color::Rgb( 42,  74, 127),
        selection: Color::Rgb( 26,  44,  74),
...
pub fn accent()           -> Color { accent_colors().primary   }
pub fn accent_light()     -> Color { accent_colors().light     }
pub fn accent_border()    -> Color { accent_colors().border    }
pub fn accent_selection() -> Color { accent_colors().selection }
