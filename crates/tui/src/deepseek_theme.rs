...
impl Theme {
    ...
    pub fn dark() -> Self {
        Self {
            ...
            section_border_color: palette::accent_border(),
            section_bg: palette::DEEPSEEK_INK,
            section_title_color: palette::accent(),
    ...
    pub fn light() -> Self {
        Self {
            ...
            plan_completed_color: palette::accent(),
        }
    }

    #[must_use]
    pub fn for_palette_mode(mode: PaletteMode) -> Self {
        match mode {
